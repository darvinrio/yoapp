...
Our naive approach manages to match the expected pricing, but offsets the effective cost of YES tokens to the NO tokens. Instead of a single 9 USD for 10 YES tokens, we get 5 USD for 10 YES tokens and 5 USD for NO tokens sold on the market for 1 USD. Instead of a 9 USD YES position at 0 USD profit, we get two positions - YES position at 4 USD profit and NO position at 4 USD loss.
