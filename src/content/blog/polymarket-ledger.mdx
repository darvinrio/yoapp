...
> *AI DISCLOSURE: The idea and the prose was largely typed by a Human. However, AI was used to give a structure and a narrative to the blog post. You can find the different versions [here](https://github.com/darvinrio/polymarket-insider-heuristics/tree/main/reports/ledger).*
...
<Image src={ContractFlow} alt="OrderMatching" caption="`OrderMatching` contract control flow" />
