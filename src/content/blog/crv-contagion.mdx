...
import crvfuturesoi from "../../assets/blog-images/crv-contagion/crv-futures-oi.png";
import crvoifunding from "../../assets/blog-images/crv-contagion/crv-oi-funding.png";
import crvliq from "../../assets/blog-images/crv-contagion/crv-liq.png";
...
<Image  src={img001}  alt="In 48 hours, CRV lost 35% of its value" caption="In 48 hours, CRV lost 35% of its value"/>
...
<Image  src={img002}  alt="crv_mcap.png" caption="$200 Million in MarketCap wiped out in 24 hours"/>
...
<Image  src={img003}  alt="tvl_drop" caption="45% of TVL dropped in 24 hours"/>

<Image  src={img004}  alt="outflows" caption="$1 Billion+ in outflows was seen on the day of hack, with $0.5 Billion returning once OTC trades were public."/>
...
<Image  src={img005}  alt="convex" caption="Convex is the largest among CRV vote liquid lockers, with as much as 40% of CRV locked under Convex"/>
...
<Image  src={img006}  alt="convex_tvl_drop" caption="Convex TVL dropped similar to Curve"/>

<Image  src={img007}  alt="and so was the price of CVX" caption="and so was the price of CVX"/>
...
<Image  src={img008}  alt="cvxCRV" caption="cvxCRV dropped as much as 35% of its peg, before recovering"/>
...
<Image  src={img009}  alt="crv-eth-liq" caption="CRV-ETH liquidity dwindled from $220M at peak to $46M before exploit"/>
...
Abracadabra were the most ruthless of the Lending Protocols, with a straightforward proposal to liquidate the CRV position straight away, moving to be the first to take advantage of the depleting liquidity. 

However Michael paid them and closed the borrow position, via MIM from CRV sold OTC, before any liquidation could unfold.


<Image  src={img011}  alt="crv-frax" caption="CRV/FRAX pool on FRAXLend hit 100% Utilization and a 85% APR at peak, forcing repayment."/>
...
<Image  src={img013}  alt="crv-otc" caption="Post failure of loan repositioning, OTC CRV sales allowed repayment of loans across the multiple lending protocols"/>
...
<Image src={crvfuturesoi} alt="crv-futures-oi" caption="3X the normal OI at peak"/>

<Image src={crvoifunding} alt="crv-oi-funding" caption="0.32% or 100% APR to short CRV at peak"/>
...
<Image src={crvliq} alt="crv-liq" caption="A total $10M positions liquidated in 4 days, with $5M in August 1 alone."/>
