...
<Image
  src={ContractFlow}
  alt="Contract flow"
  caption="Flow of control in contract"
/>
...
<Image
  src={NotionalAndYield}
  alt="notional_and_yield_farming"
  caption="Labelling Notional and yield farming helps label around 50% of the trades in these price ranges"
/>
